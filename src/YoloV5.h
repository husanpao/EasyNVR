...
#ifndef EASYNVR_YOLOV5_H
#define EASYNVR_YOLOV5_H
...
public:
     ...
     * 预测函数
     * @param img 图片
     * @param algorithm_list 算法列表
     * @return
     */
    std::vector<Event> prediction(cv::Mat img, set<string> algorithm_list);
